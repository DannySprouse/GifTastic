...
// Create an array of feelings that will be used to build original buttons

var feelings = ["Fear", "Surprise", "Bored", "Angry", "Anticipation", "Disgust", "Happy", "Sad", "Frustrated", "Confused", "Excited", "Tired"];

// Loop through the feelings array and create a button for each feeling, then append to page
...
function makeButtons(){
    ...
    for (var i = 0; i < feelings.length; i++){
        ...
        button.attr("data-name", feelings[i]);
